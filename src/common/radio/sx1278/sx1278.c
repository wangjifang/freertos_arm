    ...
    case MODEM_LORA:
        {
            ...
            {
                SX1278.Settings.LoRa.LowDatarateOptimize = TRUE;
            }
            else
            {
                SX1278.Settings.LoRa.LowDatarateOptimize = FALSE;
            }
    ...
    case MODEM_FSK:
        {
            airTime = round( ( 8 * ( SX1278.Settings.Fsk.PreambleLen +
                                     ...
                                     SX1278.Settings.Fsk.Datarate ) * 1e6 );
        }
        break;
    case MODEM_LORA:
        {
    ...
    case MODEM_LORA:
        {
            ...
            else
            {
                ...
                //周立功需要增加的配置
                uint8_t map = RFLR_DIOMAPPING1_DIO0_00 | RFLR_DIOMAPPING1_DIO1_11 | RFLR_DIOMAPPING1_DIO2_11 | RFLR_DIOMAPPING1_DIO3_11;
                SX1278Write(REG_DIOMAPPING1, map);
                map = RFLR_DIOMAPPING2_DIO4_10 | RFLR_DIOMAPPING2_DIO5_11;
                SX1278Write(REG_DIOMAPPING2, map);
    ...
    case MODEM_LORA:
        {
            ...
            else
            {
                ...
                //周立功需要增加的配置
                uint8_t map = RFLR_DIOMAPPING1_DIO0_01 | RFLR_DIOMAPPING1_DIO1_11 | RFLR_DIOMAPPING1_DIO2_11 | RFLR_DIOMAPPING1_DIO3_11;
                SX1278Write(REG_DIOMAPPING1, map);
                map = RFLR_DIOMAPPING2_DIO4_00 | RFLR_DIOMAPPING2_DIO5_11;
                SX1278Write(REG_DIOMAPPING2, map);
        ...
        case RF_RX_RUNNING:
            ...
            case MODEM_FSK:
                ...
                if( ( SX1278.Settings.FskPacketHandler.Size == 0 ) && ( SX1278.Settings.FskPacketHandler.NbBytes == 0 ) )
                {
                    ...
                    SX1278ReadFifo( RxBuffer + SX1278.Settings.FskPacketHandler.NbBytes, SX1278.Settings.FskPacketHandler.Size - SX1278.Settings.FskPacketHandler.NbBytes );
                ...
                {
                    RadioEvents->RxDone( RxBuffer, SX1278.Settings.FskPacketHandler.Size, SX1278.Settings.FskPacketHandler.RssiValue, 0 ); 
                } 
                SX1278.Settings.FskPacketHandler.PreambleDetected = FALSE;
                SX1278.Settings.FskPacketHandler.SyncWordDetected = FALSE;
                SX1278.Settings.FskPacketHandler.NbBytes = 0;
            ...
            case MODEM_LORA:
                {
                    ...
                    SX1278ReadFifo( RxBuffer, SX1278.Settings.LoRaPacketHandler.Size );
                    ...
                    if( ( RadioEvents != NULL ) && ( RadioEvents->RxDone != NULL ) )
                    {
                        RadioEvents->RxDone( RxBuffer, SX1278.Settings.LoRaPacketHandler.Size, SX1278.Settings.LoRaPacketHandler.RssiValue, SX1278.Settings.LoRaPacketHandler.SnrValue );
                    }
                }
                break;
            default:
    ...
    {                
        case RF_RX_RUNNING:
            ...
            case MODEM_FSK:
                ...
                {
                    SX1278ReadFifo( ( RxBuffer + SX1278.Settings.FskPacketHandler.NbBytes ), SX1278.Settings.FskPacketHandler.FifoThresh );
        ...
        case RF_TX_RUNNING:
            ...
            case MODEM_FSK:
                ...
                {
                    SX1278WriteFifo( ( RxBuffer + SX1278.Settings.FskPacketHandler.NbBytes ), SX1278.Settings.FskPacketHandler.ChunkSize );
                    SX1278.Settings.FskPacketHandler.NbBytes += SX1278.Settings.FskPacketHandler.ChunkSize;
                }
                else 
                {
                    // Write the last chunk of data
                    SX1278WriteFifo( RxBuffer + SX1278.Settings.FskPacketHandler.NbBytes, SX1278.Settings.FskPacketHandler.Size - SX1278.Settings.FskPacketHandler.NbBytes );
                    SX1278.Settings.FskPacketHandler.NbBytes += SX1278.Settings.FskPacketHandler.Size - SX1278.Settings.FskPacketHandler.NbBytes;
                }
                break;
            case MODEM_LORA:
