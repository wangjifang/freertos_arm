...
#define SERIAL_BUF_RECV_SQQ_LEN         254u
...
void serial_fsm_init(uint8_t serial_id)
{
    ...
    uart_int_cb_reg(serial_char_handle);
...
{
    uart_send_string(id, string, len);
}
